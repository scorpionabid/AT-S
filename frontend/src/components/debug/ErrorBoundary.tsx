...
class ErrorBoundary extends Component<Props, State> {
  ...
  render() {
    if (this.state.hasError) {
      // Use a function component wrapper to access the theme context
      const ErrorDisplay = () => {
        ...
        return (
          <div className={cn(
            ...
            'bg-gray-50 dark:bg-gray-900' // Use dark: variant for proper theming
          )}>
            <div className={cn(
              'max-w-md w-full shadow-lg rounded-lg p-6 border',
              ...
              <div className="mt-6">
                <button
                  ...
                  className="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 dark:focus:ring-offset-gray-800 transition-colors duration-200"
                >
                  Səhifəni Yenilə
                </button>
              </div>
