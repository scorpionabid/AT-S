...
class UserTest extends ModelTestCase
{
    ...
    {
        $user = User::factory()->create();
        $role = \Spatie\Permission\Models\Role::create(['name' => 'test-role', 'guard_name' => 'api']);
    ...
    {
        $user = User::factory()->create();
        $permission = \Spatie\Permission\Models\Permission::create(['name' => 'test-permission', 'guard_name' => 'api']);
